...
module multiplier_11 (
  ...
  always @* begin
    b0a[0+15-:16] = a[0+15-:16] & b[0+0-:1];
    p[0+0-:1] = b0a[0+0-:1];
    b1a[0+14-:15] = a[0+14-:15] & b[1+0-:1];
    r1c[0+0-:1] = 1'h0;
